...
from informes.models import informe,entecontrol,dependencia,entrega,evidencia
from django.http.response import JsonResponse
from django.http import JsonResponse
from django.shortcuts import get_object_or_404
from django.http import HttpResponseNotAllowed
from informes.forms import fente,fdependencia,ReviewForm,finforme,fevidencia
            ...
            if dias_anticipacion > 0:
                mensaje_html = f"""
                    ...
                    <body>
                        ...
                        <p><a style="background: green; color: white; border-style: solid; border-width: 1px; border-color: white; padding: 5px; text-decoration: none; border-radius: 20px;" type="button" href="">Ver informe</a> | <a style="background: green; color: white; border-style: solid; border-width: 1px; border-color: white; padding: 5px; text-decoration: none; border-radius: 20px;" type="button" href="">Mesa de ayuda</a></p>
                    </body>
                    </html>
                """
...
def listado(request):
    username = request.user.username
    es_staff = request.user.is_staff
    datos = informe.objects.all().select_related('entecontrol', 'dependencia')  
